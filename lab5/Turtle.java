...
public class Turtle {
	...
	public Turtle(Turtle other) {
		...
		double angle = other.leakDirection().getAngle();

		this.position = new Point2(other.getPosition());
		this.direction = new Direction2();
		this.direction.setAngle(angle);
		this.pen = new Pen(other.getPen());
	...
	public void setPenColor(Color c) {
		Color oldColor = this.getPen().getColor();
		this.pen.setColor(c);
		TurtleCommand command = new TurtleCommandSetPenColor(this, oldColor, c);
	...
	public Direction2 getDirection() {
		...
		direction.setAngle(this.direction.getAngle());
	...
	public void repeatCommands(int n) {
		List<TurtleCommand> copy = new ArrayList<TurtleCommand>(this.getCommands());
		for (int i = 0; i < n; i++) {
			for (TurtleCommand c : copy) {
				c.execute();
			}
		}
	}
