...
public class CourseOffering {
	...
	public CourseOffering(Course course, int capacity, char term, char section, int year, LocalDate openUntil) {
		if (course == null || (term != 'F' && term != 'W' && term != 'S')) {
			throw new IllegalArgumentException("null course code or invalid term");
		}
		this.course = course;
	...
	@Override
	public int hashCode() {
		return Objects.hash(term, section, year);
	}
	...
	public boolean equals(Object obj) {
		...
		CourseOffering test = (CourseOffering) obj;

		if (this.year != test.year || this.term != test.term || this.section != test.section
				|| !this.course.equals(test.course)) {
			return false;
		}
